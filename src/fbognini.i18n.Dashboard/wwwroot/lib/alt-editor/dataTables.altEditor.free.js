            ...
            altEditor.prototype,
            {
                ...
                _setup: function () {
                    ...
                    var modal = '<div class="modal fade altEditor-modal reveal" id="' + modal_id + '" tabindex="-1" role="dialog" data-reveal>' +
                        ...
                        '<button style="margin: initial;" type="button" class="close close-button btn-close" data-bs-dismiss="modal" data-close aria-label="' + this.language.modalClose + '">' +
                        '</button>' +
                        '</div>' +
                    ...
                    for (var j in columnDefs) {
                        ...
                        if (columnDefs[j].type.indexOf("hidden") >= 0) {
                            ...
                            // Adding text-inputs and error labels, but also new HTML5 types (email, color, ...)
                                ...
                                data += "<input class='" + (columnDefs[j].type == 'checkbox' ? 'form-check-input' : 'form-control') + "' "
